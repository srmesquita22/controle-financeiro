...
<div class="container mx-auto mt-8 px-4">
    ...
    <form action="{{ route('contas.update', $conta->id) }}" method="POST" class="w-full max-w-lg">
        ...
        <div class="mb-4">
            ...
            <textarea class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="descricao" name="descricao" rows="3">{{ $conta->descricao }}</textarea>
        </div>
